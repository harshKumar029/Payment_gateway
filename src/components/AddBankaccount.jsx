    ...
    return (
        <div  className=' bg-[#1B1E21]' >
            <div className='bg-[#151719]'>
                <div className=" flex justify-between pl-16 pr-16 mx-px py-6">
                    <div>
                        <h1 className="flex">
                            <div className="mr-1 font-bold text-[#fff] text-opacity-25 text-xl">Bank Account</div>
                            <div className=" text-gray-400 text-xl">Details</div>
                        </h1>
                    </div>
